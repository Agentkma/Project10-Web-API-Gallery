...
var spotifyOptions = {
ids: ["41MnTivkwTO3UUJ8DrqEJJ","5XzokqsAmkv0cjk1kAUwiM","4Dk1fhh3nqIt5dOq6sGc1f","2Wa1LMgomQa5OJuaOSnv1B","3nsnirLpQt68OIy6Lih2u5","3IpvmE4e3TMq7TmqAl8OGF","0Jk5J9HrDmCEKV7xYmaB6m"],
...
var displayAlbums =function (data) {
	...
	///the callBackFunction takes 2 arguments function ( i , value)  where i is the index value of the current array item, and value is the value of the current array item
    	 ...
    	 albumHTML += ' <a href= " ' + data.albums.artists[1].href + ' "  class = "image" >' ; // .href is the prop needed to access the link
    	 albumHTML += '<img src= "'+ data.albums.images[1].url + ' " >  </a> </li>'; //.images.url is the prop in the spotify json object with the pic/jpg
