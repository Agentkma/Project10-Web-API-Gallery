...
var spotifyAPI = "https://api.spotify.com/v1/albums?jsoncallback=?";
...
///the callBackFunction takes 2 arguments function ( i , value)  where i is the index value of the current array item, and value is the value of the current array item
    	 ...
    	 albumHTML += ' <a href= " ' + album.href + ' "  class = "image" >' ; // .href is the prop needed to access the link
    	 albumHTML += '<img src= "'+ album.images[1].url + ' " >  </a> </li>'; //.images.url is the prop in the spotify json object with the pic/jpg
    });//END anonymous funcition
